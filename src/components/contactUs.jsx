...
import { db } from '../firebase/firebase'; // Make sure the firebase setup file is correctly imported
...
function ContactUS() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Message submitted successfully:', docRef.id);
      ...
      setSuccessMessage(""); // Clear the success message if there was an error
    }
  };
  ...
  return (
    <div className="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-8 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-white mt-4 font-[sans-serif] before:absolute before:right-0 before:w-[300px] before:bg-blue-400 before:h-full max-md:before:hidden">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-4 leading-relaxed">Have a specific inquiry or looking to explore new opportunities? Our experienced team is ready to engage with you.</p>
        ...
        <ul class="mt-4 flex flex-wrap justify-center gap-6">
                    <li class="flex items-center text-blue-600">
                        ...
                        <a href="javascript:void(0)" class="text-sm ml-4">
                            <strong>rolemaster21@gmail.com</strong>
                        </a>
                    </li>
                    <li class="flex items-center text-blue-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='currentColor'
            ...
            <div class="z-10 relative h-full max-md:min-h-[350px]">
                <iframe src="https://maps.google.com/maps?q=NEWDElhi&t=&z=13&ie=UTF8&iwloc=&output=embed"
